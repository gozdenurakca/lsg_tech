      ...
      <section className="bg-gradient-to-r from-blue-950 to-indigo-900 text-white py-24">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 max-w-3xl mx-auto text-lg">
            SQL Injection, XSS ve bot saldırılarına karşı gelişmiş
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            Web Firewall çözümümüz, uygulama seviyesinde gelen
            zararlı trafiği analiz eder ve otomatik olarak engeller.
            Hem performans hem güvenlik sağlar.
          </p>
