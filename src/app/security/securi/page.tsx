    ...
    <main className="bg-[#f5f7fa] min-h-screen">
      <section className="bg-gradient-to-r from-indigo-950 to-blue-950 text-white py-24">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 max-w-3xl mx-auto text-lg">
            Web sitenizi DDoS saldırılarına, zararlı yazılımlara ve güvenlik
            açıklarına karşı 7/24 koruyun.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            Securi, gelişmiş Web Application Firewall (WAF), DDoS koruması ve
            malware temizleme sistemi ile sitenizi proaktif olarak savunur.
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-xl border p-10">
          <h3 className="text-2xl font-bold mb-6">Başlangıç Paketi</h3>

          <div className="text-4xl font-bold text-indigo-900 mb-2">₺499</div>
      ...
      <section className="bg-white py-24 border-t">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12 text-center">
          <div>
            <GlobeIcon className="w-10 h-10 text-indigo-900 mx-auto mb-4" />
          ...
          <div>
            <ActivityIcon className="w-10 h-10 text-indigo-900 mx-auto mb-4" />
          ...
          <div>
            <ServerIcon className="w-10 h-10 text-indigo-900 mx-auto mb-4" />
