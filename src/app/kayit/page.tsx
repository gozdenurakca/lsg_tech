...
export default function KayitPage() {
  ...
  const validate = () => {
    ...
    if (!form.securityQuestion || !form.securityAnswer)
      return "Güvenlik sorusu ve cevabı zorunludur.";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (login?.error) {
        setError(
          "Kayıt yapıldı ama giriş başarısız. Lütfen giriş yapmayı deneyin.",
        );
        return;
      }
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{ maxWidth: 900, margin: "40px auto", padding: "0 24px 60px" }}
        >
          ...
          <form onSubmit={handleSubmit}>
            <div className="reg-section">
              ...
              <p className="reg-section-desc">
                Bu bilgiler hesabınıza bağlanacaktır
              </p>
            ...
            <div className="reg-section">
              ...
              <p className="reg-section-desc">
                Giriş yapmak için kullanacağınız bilgiler
              </p>
