      ...
      <section className="relative bg-gradient-to-br from-blue-950 via-indigo-950 to-blue-900 text-white py-28 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 text-lg max-w-3xl mx-auto">
            *.domaininiz.com formatındaki tüm alt domainleri
            tek sertifika ile güvence altına alın.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-20 items-start">
        ...
        <div>
          ...
          <p className="text-slate-600 mb-10 leading-relaxed">
            blog.domain.com, shop.domain.com, api.domain.com gibi
            tüm alt alan adlarını ayrı ayrı sertifika almadan
            merkezi ve ekonomik şekilde koruyun.
          </p>
