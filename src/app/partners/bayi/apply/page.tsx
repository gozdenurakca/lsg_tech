      ...
      <main className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="bg-white p-14 rounded-3xl shadow-2xl text-center max-w-xl">
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            Bayilik başvurunuz başarıyla iletildi.
            Partner ekibimiz kısa süre içinde sizinle iletişime geçecektir.
          </p>

          <Link
            href="/kurumsal/bayilik"
      ...
      <section className="relative bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white py-28 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-6">
            LSG Enterprise Bayilik Başvurusu
          </h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto leading-relaxed">
            SSL ve siber güvenlik ürünlerimizi kendi markanızla sunarak
            ölçeklenebilir bir gelir modeli oluşturun.
          </p>
        </div>
      </section>
          ...
          <div className="bg-white p-12 rounded-3xl shadow-xl border">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-xs text-slate-500 text-center">
                Başvurular manuel olarak değerlendirilir.
              </p>
