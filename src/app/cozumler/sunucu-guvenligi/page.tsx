      ...
      <section className="py-28 bg-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-slate-600 max-w-3xl mx-auto">
            Çoğu saldırı fark edilmeden sistemlere sızar.
            Yanlış yapılandırma ve güncellenmemiş servisler kritik risk oluşturur.
          </p>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group bg-[#f4f6f8] p-10 rounded-3xl shadow-md hover:shadow-2xl transition-all hover:-translate-y-2"
              >
                <item.icon className="w-8 h-8 text-blue-900 mb-6 mx-auto group-hover:scale-110 transition-transform" />
      ...
      <section className="py-28 bg-[#f4f6f8]">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
          ...
          {[
            ...
            >
              <item.icon className="w-10 h-10 text-blue-900 mb-6 group-hover:scale-110 transition-transform" />
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold">
              Neden LSG Sunucu Güvenliği?
            </h2>

            <p className="mt-6 text-slate-600 leading-relaxed">
              Merkezi güvenlik paneli ve otomatik patch yönetimi ile
              altyapınızı sürekli güncel ve korumalı tutuyoruz.
            </p>
