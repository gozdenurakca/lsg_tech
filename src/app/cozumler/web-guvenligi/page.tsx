    ...
    <main className="bg-[#f4f6f8] text-slate-900">
      ...
      <section className="bg-slate-100 border-b">
        <div className="max-w-6xl mx-auto px-6 py-4 text-sm text-slate-600">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-900 font-semibold">Web Sitesi Güvenliği</span>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-white/90">
                <span className="text-sm font-semibold tracking-wide">ENTERPRISE WEB SECURITY</span>
              ...
              <h1 className="mt-7 text-4xl md:text-6xl font-extrabold leading-tight">
                Kurumsal Web Sitesi <span className="text-blue-200">Güvenliği</span>
              </h1>

              <p className="mt-6 text-blue-100/90 text-base md:text-lg leading-relaxed max-w-xl">
                Web sitenizi malware, DDoS, bot saldırıları ve veri ihlallerine karşı
                çok katmanlı güvenlik mimarisi ile koruyun.
              </p>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span className="relative z-10">Güvenlik Analizi Talep Edin</span>
                ...
                >
                  SSL ile Birlikte Planla <span className="inline-block ml-1">→</span>
                </Link>
              </div>

              <div className="mt-10 flex flex-wrap gap-3 text-sm text-blue-100/90">
                {["SLA", "Threat Intelligence", "Incident Response", "KVKK/GDPR"].map((t) => (
                  <span key={t} className="px-3 py-1 rounded-full bg-white/10 border border-white/15">
                    {t}
                  </span>
                ))}
              </div>
              ...
              <div className="relative bg-white/10 border border-white/15 rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div className="relative p-8 text-white">
                  <div className="flex items-center justify-between">
                    <div className="text-sm font-semibold text-blue-200">Live Telemetry</div>
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center gap-3 text-sm text-blue-100/90">
                          <row.Icon className="w-4 h-4 text-blue-200" />
                          <span>{row.k}</span>
                        </div>
      ...
      <section className="py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-extrabold">Web Siteleri Neden Hedefte?</h2>
            <p className="mt-4 text-slate-600">
              Botlar, injection, brute-force ve malware girişimleri saldırı yüzeyinizi büyütür.
              Korumayı “tek ürün” değil, mimari olarak düşünmek gerekir.
            </p>
          </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="w-12 h-12 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center">
                    <t.icon className="w-6 h-6 text-blue-900" />
                  </div>
                ...
                <div className="mt-3 text-slate-600 leading-relaxed">{t.desc}</div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-extrabold">Çekirdek Yetkinlikler</h2>
            <p className="mt-4 text-slate-600">
              Saldırı yüzeyini daralt: WAF + temizleme + DDoS + izleme + müdahale.
            </p>
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            {CORE.map((c) => (
              ...
              >
                ...
                <div className="relative">
                  <div className="w-12 h-12 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center">
                    <c.icon className="w-6 h-6 text-blue-900" />
                  </div>
          ...
          <div className="mt-14 rounded-3xl p-8 md:p-10 bg-slate-50 border border-slate-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-slate-600">
                WAF kuralları + bot koruma + izleme + raporlama ile görünür sonuç.
              </p>
            </div>
            <Link
              href="/#teklif"
            ...
            >
              Baseline Kurulumu İste <ChevronRight className="w-5 h-5" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-extrabold">LSG Web Güvenlik Mimarisi</h2>
            <p className="mt-4 text-slate-600">
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="mt-5 text-slate-600 leading-relaxed">
              LSG Web Güvenliği çözümü; CDN, davranış analizi ve tehdit istihbaratı ile
              ...
              {BENEFITS.map((b) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <b.icon className="w-5 h-5 text-blue-900 mt-0.5" />
                    <span className="text-slate-800 font-semibold">{b.text}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              >
                Mimari Öneri Al <ChevronRight className="w-5 h-5" />
              </Link>
              <Link
                href="/ssl"
              ...
              >
                SSL ile Birlikte Paketle <ChevronRight className="w-5 h-5" />
              </Link>
            </div>
          </div>

          <div className="relative h-[420px] rounded-3xl overflow-hidden shadow-2xl">
            <Image src="/images/resim4.png" alt="Web Security" fill className="object-cover" />
      ...
      <section className="py-20 md:py-24 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-extrabold">Web Sitenizi Güvence Altına Alın</h2>
          <p className="mt-6 text-slate-600 leading-relaxed">
            Güvenlik uzmanlarımız mevcut altyapınızı analiz eder ve size özel koruma mimarisi tasarlar.
          </p>
          ...
          <div className="mt-6 text-sm text-slate-500">
            ✓ 24 saat içinde geri dönüş &nbsp; ✓ Taahhütsüz danışmanlık &nbsp; ✓ SLA opsiyonu
          </div>
        </div>
      </section>
    </main>
