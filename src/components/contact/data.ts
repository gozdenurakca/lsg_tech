...
export const QUICK_TOPICS: QuickTopic[] = [
  ...
  { icon: "credit", label: "Fatura & Ödeme", href: "#" },
  { icon: "ssl", label: "SSL Sertifikası", href: "#" },
  { icon: "mail", label: "E-posta Kurulumu", href: "#" },
  { icon: "hosting", label: "Hosting Sorunları", href: "#" },
  { icon: "security", label: "Web Güvenliği", href: "#" },
  { icon: "dns", label: "DNS Ayarları", href: "#" },
];
