      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          <div className="w-20 h-20 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-5">
            <CartIcon size={32} className="text-slate-400" />
          </div>
          ...
          >
            Alan Adı Ara <ArrowIcon size={15} />
          </Link>
        </div>
      </div>
    );
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-14">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-9 h-9 bg-blue-500/20 rounded-xl flex items-center justify-center">
              <CartIcon size={18} className="text-blue-400" />
            </div>
        ...
        <div className="grid md:grid-cols-5 gap-6 items-start">
          <div className="md:col-span-3 space-y-3">
            ...
            {items.map((item) => {
              ...
              const Icon = ICONS[meta.icon] || ICONS.box;
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-2 w-8 h-8 rounded-lg flex items-center justify-center text-slate-300 hover:text-red-500 hover:bg-red-50 transition-colors"
                  >
                    <TrashIcon size={15} />
                  </button>
                </div>
            ...
            <Link
              href="/domain"
              className="text-sm text-blue-600 font-semibold hover:underline flex items-center gap-1 pt-2"
            >
              ← Alışverişe devam et
            </Link>
          </div>
          ...
          <div className="md:col-span-2 sticky top-6 space-y-4">
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
              ...
              <button
                ...
                className="w-full mt-5 flex items-center justify-center gap-2 text-white font-bold py-4 rounded-xl text-sm shadow-lg shadow-blue-600/20"
                style={{
                  background:
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
              <div className="space-y-2.5">
                {[
                  { icon: "shield", text: "256-bit SSL şifreli ödeme" },
                  { icon: "box", text: "Anında aktivasyon" },
